    ...
    <View style={{ flex: 1, paddingVertical: 15, paddingHorizontal: 15 }}>
      ...
      >
        <View>
          ...
          <View style={{flexDirection:"row", alignItems:"center", gap:5, paddingTop:3}}>
            <Ionicons name="people" size={24} color={Colors.primary} />
            <Text style={{color:Colors.primary, fontWeight:400}}>{group?.length} Groups</Text>
          </View>
        </View>
        <Link href={"/(tabs)/createGroup"} style={{backgroundColor:Colors.gray, padding:8, borderRadius:12}}>
